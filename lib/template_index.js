                ...
                <body>
                        ...
                        <div class="panel panel-default panel-google-plus" style="border-radius: 10px; ">
                            <div class="panel-body">
                                ...
                                <div class="panel-heading col-12 col-sm-12" style=" text-indent : 2%;">
                                    <img class="img-circle pull-left" src="images/2.jpg"style="width: 55px;height: 55px"> 
                    ...
                    <div class="col-12 col-sm-12 col-md-12 post3"data-spy="affix">
                        ...
                        <div class="col-6 col-sm-4 col-md-4" style="">
                            <a>
                                <img src="images/user.png" style=" width: 55px;height: 55px; left: : 5%; border-radius: 10px;">
                            </a>
                        </div>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4 col-md-12">
                                                ...
                                                <div class="col-sm-1 col-md-3">
                                                    <div class="thumbnail">
                                                        <img class="img-responsive user-photo" src="images/2.jpg">
                                                    </div>
                                                </div>
